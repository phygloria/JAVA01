...
public class Application01 {
    public static void main(String[] args){
        ...
        *
        * 이러한 상속이라는 기술을 사용하게 되면 얻게되는 이점을 크게 두 가지로 불 수 있다.
        ...
        *   상속 구조가 복잡해 질 수록 그 영향에 대한 예측이 힘들며 이런한 단점이 유지보수성 증가한다는 장점과는
        *   반대로 유지보수에 악영향을 미친다.
        ...
        * 적절한 책임을 가진 개체들이 서로 협력(메세지 수신과 응답)을 통해 프로그램이 동작하는 것이
        * 객체지향 프로그램 이다.
        *
        ...
        * 그래야 자식클래스로 생상한 객체들이 서로 역할을 수행해가며 유연한 코드를 작성할 수 있게 된다.
        * 동일한 역할을 가지는 모든 객체는 동일한 메세지를 수신하기는 하지만.
        * 객체별로 그 메세세지에 응답하는 방식은 서로 다를 수 있다. (다형성)
        * */
