...
public class Application01 {
    ...
    public static void main(String[] args){
        ...
        *  1-2. ||(논리 or 연산자 : 두 개의 논리식 중 하나라도 참일 경우 참을 반환, 둘 다 모두 거짓일 경우 거짓을 반환한다.
        * 2. 논리 부정 연산자 : 피연산자가 하나인 단항연산자로, 피연산자의 결합 방식은 외쪽에서 오른쪽이다.
        *  2-2. !(논리 Not) 연산자 : 논리식의 결과가 참이라면 거짓을, 거짓이라면 참을 반환한다.
        * */
