...
public class Appliction01 {
    public static void main(String[] args){
        ...
        * 추상클래스에 작성한 메소드를 호출하게 되면 실제 후손타입의 인스턴스가 가지는 메소드는
        ...
        * publi abstract class Product(){
        *   public abstract void method();
        * }
        *
        * */

//        Product pro = new Product(); //객체가 아닌, 식별되지 않는 애들이 생성되는 것을 막을 수 있는 기능인데,
        //추상 클래스는 인스턴스 생성 불가
        SmartPhone smartPhone = new SmartPhone();
        //상속을 받을거면 너가 구현해. 자식클래스에서 상속받고 구현후 여기에 쓰면 오류 안남. 구현체계?

        smartPhone.printSmartPhone();
        smartPhone.acsMethod();
